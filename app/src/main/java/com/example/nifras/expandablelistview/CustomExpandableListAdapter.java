package com.example.nifras.expandablelistview;
...
public class CustomExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TextView expandableListView =   (TextView)convertView.findViewById(R.id.expandedListItem);
        expandableListView.setText(expandableListText);
        return convertView;
    }
